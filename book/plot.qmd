...
О различных видах графиков можно почитать по [ссылке](https://r-graph-gallery.com/l). В этом уроке мы научимся строить диаграмму рассеяния (scatter plot), столбиковую диаграмму (bar chart) и линейную диаграмму (line chart).
