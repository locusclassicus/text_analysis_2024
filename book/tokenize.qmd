...
- Видео 2024 г. ([раз](https://vkvideo.ru/video91786643_456239049) и [два](https://vkvideo.ru/video91786643_456239050))
- [Видео](https://vk.com/video91786643_456239086) 2025 г.


## Домашнее задание 

По [ссылке](https://github.com/locusclassicus/philology_2025/raw/refs/heads/main/data/tales_text.Rdata) вы найдете датасет со сказками Салтыкова-Щедрина (в формате `.Rdata`). Вам необходимо аннотировать сказки, используя модель [SynTagRus](https://universaldependencies.org/treebanks/ru_syntagrus/index.html) через пакет `{udpipe}` (версия модели 2.5). 
