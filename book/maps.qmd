...
Также см. [урок](https://agricolamz.github.io/daR4hs/7_working_with_geodata.html) о геоданных из курса Георгия Мороза. Из этого урока вы узнаете, в частности, какие бывают изображения (векторные, растровые), и как их можно хранить.
...
В этом уроке мы освоим пакет для работы с пространственными данными `{tmap}`, а также поговорим про возможности `{ggplot2}`.
...
Загрузите карту районов Москвы и список станций метро. Визуализируйте их (по отдельности или вместе). Найдите район, в котором больше всего станций метро.
:::


```{r eval=FALSE}
# Используем st_read для прямого чтения GeoJSON как sf-объекта
moscow_districts <- st_read("https://raw.githubusercontent.com/agricolamz/daR4hs/main/data/w7_moscow.geojson")
moscow_districts <- st_make_valid(moscow_districts)

# Загружаем CSV с данными метро
moscow_metro_raw <- read_csv("https://raw.githubusercontent.com/agricolamz/daR4hs/main/data/w7_moscow_metro.csv")
...
- [Видео](https://vkvideo.ru/video91786643_456239062?sh=4) 2025 г.
- Видео 2026 г. [часть 1](https://vk.com/video91786643_456239098) и часть 2.
